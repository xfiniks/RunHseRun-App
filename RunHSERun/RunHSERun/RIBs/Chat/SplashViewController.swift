...
final class SplashViewController: UIViewController {
    ...
    private let token: StreamChat.Token
    ...
    init(
        ...
        token: StreamChat.Token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoidHV0b3JpYWwtZHJvaWQifQ.NhEr0hP9W9nwqV7ZkdShxvi02C5PR7SJE7Cs4y7kyqg",
